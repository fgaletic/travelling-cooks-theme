...
<main class="container mx-auto px-4 py-8">
    ...
    ?>
        <article class="max-w-3xl mx-auto">
            ...
            <?php if ($is_recipe && $subtitle = get_post_meta(get_the_ID(), '_tc_post_subtitle', true)) : ?>
            ...
            elseif ($is_travel) :
                ...
                $best_season = get_post_meta(get_the_ID(), '_tc_best_season', true);
                $cost_rating = get_post_meta(get_the_ID(), '_tc_cost_rating', true);
                $highlights = get_post_meta(get_the_ID(), '_tc_highlights', true);
                            ...
                            <?php if ($location) : ?>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slateGray"><?php echo esc_html($location); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($duration) : ?>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slateGray"><?php echo esc_html($duration); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($best_season) : ?>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slateGray capitalize"><?php echo esc_html($best_season); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($cost_rating) : ?>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slateGray capitalize"><?php echo esc_html($cost_rating); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
            ...
            // Review details
            elseif ($is_review) :
                $product_name = get_post_meta(get_the_ID(), '_tc_product_name', true);
                            ...
                            <?php if ($rating) : ?>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slateGray"><?php echo esc_html($rating); ?> / 5</p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($price) : ?>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slateGray"><?php echo esc_html($price); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($brand) : ?>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slateGray"><?php echo esc_html($brand); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <div class="grid grid-cols-1 gap-y-3">
                                    ...
                                    foreach ($pros_array as $pro) :
                                        if (trim($pro)) : ?>
                                            <div class="flex items-start space-x-3">
                                                <span class="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-mutedPink mt-2"></span>
                                                <p class="flex-1 font-dmsans text-slateGray"><?php echo esc_html(trim($pro)); ?></p>
                                            </div>
                                        <?php endif;
                                    endforeach; ?>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-y-3">
                                    ...
                                    foreach ($cons_array as $con) :
                                        if (trim($con)) : ?>
                                            <div class="flex items-start space-x-3">
                                                <span class="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-mutedPink mt-2"></span>
                                                <p class="flex-1 font-dmsans text-slateGray"><?php echo esc_html(trim($con)); ?></p>
                                            </div>
                                        <?php endif;
                                    endforeach; ?>
                                </div>
