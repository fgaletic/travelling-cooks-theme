...
<main class="container mx-auto px-4 py-8">
    ...
    <?php // Special layout for main categories
                        ...
                        <article class="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <?php if ($price): ?>
                                        <span class="text-slateGray font-medium"><?php echo esc_html(
                                            $price
                                        ); ?></span>
                                    <?php endif; ?>
                                </div>
                                ...
                                <?php if ($quick_note): ?>
                                    <p class="text-sm text-mutedPink italic mb-4"><?php echo esc_html(
                                        $quick_note
                                    ); ?></p>
                                <?php endif; ?>
