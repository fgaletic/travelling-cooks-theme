        ...
        <div class="tc-meta-grid">
            ...
            <div class="tc-meta-field">
                ...
                <select id="tc_best_season" name="tc_best_season">
                    ...
                    <option value="spring" <?php selected($fields['best_season'], 'spring'); ?>>Spring</option>
                    <option value="summer" <?php selected($fields['best_season'], 'summer'); ?>>Summer</option>
                    <option value="autumn" <?php selected($fields['best_season'], 'autumn'); ?>>Autumn</option>
                    <option value="winter" <?php selected($fields['best_season'], 'winter'); ?>>Winter</option>
                </select>
            </div>
            ...
            <div class="tc-meta-field">
                ...
                <select id="tc_cost_rating" name="tc_cost_rating">
                    ...
                    <option value="budget" <?php selected($fields['cost_rating'], 'budget'); ?>>Budget</option>
                    <option value="moderate" <?php selected($fields['cost_rating'], 'moderate'); ?>>Moderate</option>
                    <option value="luxury" <?php selected($fields['cost_rating'], 'luxury'); ?>>Luxury</option>
                </select>
            </div>
            ...
            <div class="tc-meta-field tc-meta-full">
                ...
                <textarea id="tc_highlights" name="tc_highlights" class="tc-meta-textarea" 
                    placeholder="List the main highlights of this destination"><?php echo esc_textarea($fields['highlights']); ?></textarea>
            </div>
        </div>
    </div>
    <?php
...
function tc_save_travel_meta($post_id) {
    if (!isset($_POST['tc_travel_meta_nonce']) || 
    ...
    $fields = ['location', 'duration', 'best_season', 'cost_rating', 'highlights'];

    foreach ($fields as $field) {
        if (isset($_POST['tc_' . $field])) {
            $value = $field === 'highlights' ? 
